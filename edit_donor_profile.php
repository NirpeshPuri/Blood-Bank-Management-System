...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($nameError === "" && $addressError === "" && $phoneError === "" && $emailError === "" && $ageError === "" && $weightError === "" && $passwordError === "") {
        $sql = "UPDATE user SET name='$existingName', address='$existingAddress', phone='$existingPhone', blood_type='$newBloodType', age='$existingAge', weight='$existingWeight', email='$existingEmail' WHERE name='$donor'";

        if ($conn->query($sql) === TRUE) {
            echo "<script>alert('Profile updated successfully');</script>";
            echo "<script>window.location='edit_donor_profile.php';</script>";
            exit();
        } else {

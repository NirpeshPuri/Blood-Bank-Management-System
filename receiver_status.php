...
$sqlReceiverRequests = "SELECT * FROM make_request WHERE user=?";
...
<div class="container">
        ...
        <table>
            ...
            while ($row = $resultReceiverRequests->fetch_assoc()) {
                ...
                echo "<td><a href='edit_receiver_request.php?req_id=" . $row['req_id'] . "'>Edit Request</a><br>
                <a href='reject_rec_own_req.php?req_id=" . $row['req_id'] . "'>Delete Request</a></td>";
                echo "</tr>";
            }
            ?>
        </table>
        <a href="receiver_dashboard.php">Go to dashboard</a>
        <br><br>
    </div>
</body>
</html>
